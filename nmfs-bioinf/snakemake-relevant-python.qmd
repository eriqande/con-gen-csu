...
exit
```
which will drop you hack into R.
...
as attributes of a `wildcards` object (e.g. you can get their values using, for example,
...
includes `snakemake`.  (Remember the line like `use_condaenv(condaenv = "/projects/eriq@colostate.edu/mambaforge/envs/snakemake-8.5.3")`?)  Otherwise,
