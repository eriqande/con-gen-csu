...
**a comment: I don't see the git interface buttons in the RStudio session, this might be a nice place to recap that setup if its necessary, and if its different from the previous R steps. Also I just don't remember lol and will need to go look it up. **
...
Finally, from your Alpine dashboard in your browser, you can even get a shell
...
get to this on your phone or tablet browser.  (Just when you thought cluster computing
...
**Any disconnect instructions other than closing your browser?**
