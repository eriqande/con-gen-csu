...
(base) [ldurkee@colostate.edu@login13 con-gen-csu]$ echo "my name is Lily"
...
(base) [ldurkee@colostate.edu@login13 con-gen-csu]$ cd /assignments/002-unix-intro

-----

(base) [ldurkee@colostate.edu@login13 002-unix-intro]$

#### Ex. 3: print the absolute path of the directory 002-unix-intro that you just changed into

(base) [ldurkee@colostate.edu@login13 002-unix-intro]$ pwd
...
(base) [ldurkee@colostate.edu@login13 002-unix-intro]$ ls
...
(base) [ldurkee@colostate.edu@login13 002-unix-intro]$ ls /projects/ldurkee@colostate.edu/con-gen-csu/
...
(base) [ldurkee@colostate.edu@login13 002-unix-intro]$ ls -a /projects/ldurkee@colostate.edu/con-gen-csu/
...
(base) [ldurkee@colostate.edu@login13 .git]$ ls
...
(base) [ldurkee@colostate.edu@login13 002-unix-intro]$ ls fastq/DPCh_plate1_A
...
(base) [ldurkee@colostate.edu@login13 002-unix-intro]$ ls fastq/DPCh_plate1_A06_S6.R1.fq.gz
...
(base) [ldurkee@colostate.edu@login13 002-unix-intro]$ mkdir lonely-fastqs
(base) [ldurkee@colostate.edu@login13 002-unix-intro]$ cd lonely-fastqs/
(base) [ldurkee@colostate.edu@login13 lonely-fastqs]$ mkdir R1 R2
...
(base) [ldurkee@colostate.edu@login13 lonely-fastqs]$ cp /projects/ldurkee@colostate.edu/con-gen-csu/assignments/002-unix-intro/fastq/*R1* 
/projects/ldurkee@colostate.edu/con-gen-csu/assignments/002-unix-intro/lonely-fastqs/R1

(base) [ldurkee@colostate.edu@login13 lonely-fastqs]$ cp /projects/ldurkee@colostate.edu/con-gen-csu/assignments/002-unix-intro/fastq/*R2* 
...
(base) [ldurkee@colostate.edu@login13 lonely-fastqs]$ ls -R
...
(base) [ldurkee@colostate.edu@login13 002-unix-intro]$ rm -r lonely-fastqs
