...
The fragments are complementary strands.
...
The sequencing binding site is an inserted DNA sequence designed to bind downstream sequencing oligonucleotides (or primers). Primers are short single strands of synthetic RNA or DNA that contain a free 3'-hydroxyl group. DNA polymerase can only add nucleotides to the 3'-hydroxyl group of an existing sequence and synthesizes DNA in the 5' to 3' direction. Therefore the sequencing binding site is necessary to bind a sequencing primer and provide a platform for DNA polymerase to conduct 'sequencing by synthesis'. 
...
The Original Template is anchored by its 3' end.
...
The remaining strand is anchored by its 5' end.
...
This aligns with my previous answers.
