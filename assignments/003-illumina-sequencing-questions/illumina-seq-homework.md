...
The sequencing binding are the oligonucleotides between the fragment of DNA we are interested in and the indices which attach to the flow cell binding sites. This is where sequencing begins so there must be a free 3' hydroxyl so that polymerase can synthesize the strand of DNA.
...
the remaining strand is the reverse complement of the original template. it is anchored by its 5' end.
...
The blue part of the remaining strand is the 3' end and is complementary to the blue oligos on the lawn
...
No, it is sequenced off the reverse of the that strand.
