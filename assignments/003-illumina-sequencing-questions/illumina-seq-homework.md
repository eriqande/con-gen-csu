...
False - each fragment is one strand
...
The sequencing binding sites allow oligonucleotide primers to attach to the DNA strand. The 3'-hydroxyl on the primer is a starting point for new strand synthesis (by a polymerase) that is utilized by Illumina.
...
They move 5' to 3'. It is anchored by the 5' end.
...
It is the reverse complement. This will be anchored by the 5' end.
