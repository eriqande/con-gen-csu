...
A2: The sequence on the bottom is the reverse complement of the sequence on top
...
A3: The sequencing binding site provides the 3'-hydroxyl group required for the polymeraseto attach oligonucleotide for synthesis to occur from the 5' to 3' end of the strand being synthesized. 
...
A5: The remaining stand is the reverse complement of the original template and is attached by the 5' end
...
A7: the blue part attaches to the lawn at the 3' end and is complementary to the blue lawn oligos
(sorry the question wasn't clear so I wrote my best interpretation of what was being asked)
...
A8: Yes, because if the blue oligos are attaches at the 3' end, then the 5' end will have to be the binding site for the polymerase.
